  ...
  return (
    <div className="min-h-screen bg-[#F0EEE9] animate-fade-in">
      ...
      <main className="max-w-[1440px] mx-auto px-6 py-6">
        {/* Project Title */}
        <div className="mb-8">
          <h1 className="text-5xl font-bold text-gray-900 mb-2" style={{ fontFamily: 'Young Serif', fontSize: '48px' }}>{project?.name || 'Loading...'}</h1>
          {project?.description && (
        ...
        <div className="lg:hidden mb-4">
          ...
          >
            ...
            {sidebarOpen ? 'Hide Sidebar' : 'Show Members & Documents'}
          </Button>
        </div>
        ...
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          <div className="flex-1 space-y-6 order-2 lg:order-1">
            ...
            <section className="bg-white rounded-lg p-6 shadow-lg border border-gray-300">
            ...
            <>
              <div className="space-y-2">
                {activeBoards.map((board) => (
                  <div key={board.id} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg border border-gray-200 hover:bg-gray-100 transition-colors">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      />
                      <Button variant="ghost" asChild className="h-8 px-3 text-sm">
                      ...
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                          <DropdownMenuItem onClick={() => setArchiveBlueprintId(board.id)}>
          ...
          <div className={`w-full lg:w-1/5 space-y-6 order-1 lg:order-2 ${sidebarOpen ? 'block' : 'hidden lg:block'}`}>
            ...
            <section className="bg-white rounded-lg p-6 shadow-lg border border-gray-300">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h2 className="text-xl font-semibold">Documents & Links</h2>
              </div>
