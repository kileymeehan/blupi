  ...
  return (
    <div className="min-h-screen bg-slate-50 animate-fade-in">
      <header className="border-b bg-white shadow-sm">
        <div className="max-w-[1440px] mx-auto flex h-14 items-center px-6">
          <div className="flex-1 flex items-center gap-6">
            ...
            <h2 className="text-base font-semibold text-muted-foreground"></h2>
          </div>
      ...
      <main className="max-w-[1440px] mx-auto px-6 py-6 space-y-6">
        ...
        <section className="bg-white rounded-lg p-6 shadow-sm border-2 border-gray-300">
          <div className="flex justify-between items-center mb-4">
            ...
            <Button
              ...
              className="bg-[#4679A6] hover:bg-[#A04922] h-8 text-sm"
            >
        ...
        <section className="bg-white rounded-lg p-8 shadow-sm border-2 border-gray-300">
          <div className="flex justify-between items-center mb-6">
            ...
            <Button
              ...
              className="bg-[#4679A6] hover:bg-[#A04922]"
            >
        ...
        <section className="bg-white rounded-lg p-8 shadow-sm border-2 ">
          <div className="flex justify-between items-center mb-6">
            <div className="flex items-center gap-2">
              <LayoutGrid className="h-6 w-6 text-primary" />
