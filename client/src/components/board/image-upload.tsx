...
export default function ImageUpload({ onImageChange, currentImage }: ImageUploadProps) {
  ...
  return (
    <>
      <div 
        onClick={handleClick}
        className="mb-2 h-40 border-2 border-dashed border-gray-200 rounded-lg flex flex-col items-center justify-center text-gray-400 hover:text-gray-600 hover:border-gray-300 transition-colors cursor-pointer relative overflow-hidden w-[205px]"
      >
        <input
          type="file"
          ref={fileInputRef}
