            ...
            <Dialog open={inviteOpen} onOpenChange={setInviteOpen}>
              <DialogContent>
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Add team members to collaborate on this blueprint.
                  </DialogDescription>
                </DialogHeader>
                <div className="mt-4">
                  <Input
            ...
            <Dialog open={shareLinkOpen} onOpenChange={setShareLinkOpen}>
              <DialogContent>
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Share this blueprint with others using these links.
                  </DialogDescription>
                </DialogHeader>
                <div className="mt-4 space-y-4">
                  <div>
                    <h3 className="text-sm font-medium mb-2">Team Access Link</h3>
                  ...
                  <div>
                    <h3 className="text-sm font-medium mb-2">Public Access Link</h3>
                    <div className="flex gap-2">
                      <Input
