                            ...
                            <div className="px-4">
                              ...
                              <div className="flex gap-8">
                                {phase.columns.map((column, columnIndex) => (
                                  <div key={`minimap-${column.id}`} className={`flex-shrink-0 w-[270px] flex flex-col rounded-lg px-2 ${showAlternatingColumns && columnIndex % 2 === 0 ? 'bg-gray-100' : ''}`}>
                                ...
                                >
                                  {(provided, snapshot) => (
                                    <div
                                      ...
                                      className={`flex-shrink-0 w-[220px] sm:w-[240px] md:w-[270px] flex flex-col rounded-lg px-2 ${showAlternatingColumns && columnIndex % 2 === 0 ? 'bg-gray-100' : ''}`}
                                      style={{
