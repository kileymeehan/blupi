...
export function SheetsConnectionDialog({
  ...
  const [selectedValue, setSelectedValue] = useState<string>(
    initialConnection?.sheetId ? initialConnection.sheetId : BOARD_SHEETS[0].sheetId
  );
  ...
  const handleConnect = () => {
    ...
    try {
      ...
      if (isConnectingNew) {
        ...
        sheetId = match ? match[1] : BOARD_SHEETS[0].sheetId;
      }
      ...
      // Create the connection object without any asynchronous operations
